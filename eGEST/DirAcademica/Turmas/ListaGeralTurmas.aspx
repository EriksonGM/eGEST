<%@ Page Title="" Language="C#" MasterPageFile="~/LayOut.Master" AutoEventWireup="true" CodeBehind="ListaGeralTurmas.aspx.cs" Inherits="eGEST.DirAcademica.Turmas.ListaGeralTurmas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div class="box">
           ...
           <div class="row">
            ...
            <asp:ListView ID="lvTurmas" runat="server" DataSourceID="SqlDataSourceTurmas" DataKeyNames="Id_Turma">
                ...
                <ItemTemplate>
                    <tr style="">
                        <td>
                            <asp:Label Text='<%# Eval("Id_Turma") %>' runat="server" ID="Id_TurmaLabel" /></td>
                        <td>
        ...
        <div class="box-footer">
                <a class="btn btn-success pull-right" href="CrearTurma.aspx"><i class="fa fa-plus"></i>&nbsp; Criar Turma</a>
        </div>
        <!-- /.box-footer-->
    </div>
    <!-- /.box -->
